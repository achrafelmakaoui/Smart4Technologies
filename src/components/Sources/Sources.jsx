        ...
        <div className='sourcesContainer'>
            ...
            <div className='sources-content2'>
                <div className='sources-imgFt4'>
                    <img src={Method2} className="Method2"/>
                </div>
                <div className='sources-textFt2'>
            ...
            <div className='sources-content2'>
                <div className='sources-imgFt5'>
                    <img src={Method3} className="Method3"/>
                </div>
                <div className='sources-textFt2'>
            ...
            <div className='sources-content2'>
                ...
                <div className='sources-imgFt2'>
                    <img src={GreenH2} className="GreenH2"/>
                </div>
            </div>
            ...
            <h3 className='sectionRef'>Reference table: <span onClick={() => { window.open('https://www.senat.fr/rap/r20-536/r20-5361.pdf', '_blank')}}>https://www.senat.fr/rap/r20-536/r20-5361.pdf</span></h3>
        </div>
    </div>
  )
}
