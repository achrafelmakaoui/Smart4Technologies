...
export function SignupFormDemo() {
  ...
  return (
    <div className="signup-container">
      <img className="signup-img" src={signUpLogo} alt="signUpLogo"/>
      <h2 className="signup-title">Sign Up</h2>
      <p className="signup-subtitle">
      Join Us Today and Ignite Your Hydrogen Journey
      </p>
      <form className="signup-form" onSubmit={handleSubmit}>
        <div className="input-group">
          <LabelInputContainer>
            <Label htmlFor="firstname">First name</Label>
            <Input id="firstname" placeholder="Fadl" type="text" />
          </LabelInputContainer>
          <LabelInputContainer>
            <Label htmlFor="lastname">Last name</Label>
            <Input id="lastname" placeholder="Ahmed" type="text" />
          </LabelInputContainer>
        ...
        <p className="Register-pthg">Already Have An Account? <Link to='/signin'><mark>Signin Now</mark></Link></p>
