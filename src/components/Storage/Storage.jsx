        ...
        <div className='storageContainer'>
            ...
            <div className='storage-contentheader'>
                <div className='storage-imgFt'>
                    <img src={hydroStorage} className="hydroStorage" alt='storage'/>
                </div>
            ...
            <div className='storage-content2'>
                ...
                <div className='storage-imgFt2'>
                    <img src={Thank} className="Thank" alt='storage'/>
                </div>
            </div>
            ...
            <div className='storage-imgFt5'>
                    <img src={storage1} className="storage1" alt='storage'/>
                </div>
                <div className='storage-textFt2'>
            ...
            <div className='storage-content2'>
                <div className='storage-imgFt5'>
                    <img src={storage2} className="storage2" alt='storage'/>
                </div>
                <div className='storage-textFt2'>
            ...
            <div className='storage-content2'>
                <div className='storage-imgFt5'>
                    <img src={storage3} className="storage3" alt='storage'/>
                </div>
                <div className='storage-textFt2'>
            ...
            <div className='storage-content2'>
                <div className='storage-imgFt5'>
                    <img src={storage4} className="storage4" alt='storage'/>
                </div>
                <div className='storage-textFt2'>
            ...
            <div className='storage-content2'>
                <div className='storage-imgFt5'>
                    <img src={storage5} className="storage5" alt='storage'/>
                </div>
                <div className='storage-textFt2'>
